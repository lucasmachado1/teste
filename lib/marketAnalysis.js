...
function buildRiskPlan({ candles, currentPrice, signal, forecast, volatility20 }) {
  ...
  return {
    ...
    invalidation: direction === 'LONG'
      ? 'Perde força se fechar candle de 15m abaixo do stop ou se EMA12 cruzar abaixo da EMA26.'
      : 'Perde força se fechar candle de 15m acima do stop ou se EMA12 cruzar acima da EMA26.',
